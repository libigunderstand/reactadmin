...
class Login extends Component {
    ...
    signup = async ({ username, password })=> {
        ...
        if(resdata.result) {
            if(resdata.result.flag === 1) {
                this.openNotificationWithIcon('success','注册成功！','用户注册成功！')
            }else if(resdata.result.flag === 2) {
                this.openNotificationWithIcon('error','注册失败！','用户注册失败！')
            }else {
                this.openNotificationWithIcon('error','注册失败！','该用户名已存在！')
            }
        }
    }
